...
from .views import BlogsView, CreateBlogView, UpdateBlogView, DeleteBlogView, CommentsView, CreateCommentView, UpdateCommentView, DeleteCommentView, LikesView, LikeBlogView
