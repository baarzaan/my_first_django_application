...
from .views import BlogsView, CreateBlogView, UpdateBlogView, DeleteBlogView, CommentsView, CreateCommentView, UpdateCommentView, DeleteCommentView, LikesView, AddLikeView, DeleteLikeView
...
urlpatterns = [
    ...
    path("delete-like/<str:pk>/", DeleteLikeView.as_view(), name="delete-like"),
]